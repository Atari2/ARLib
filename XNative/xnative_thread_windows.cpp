...
namespace ARLib {
    ...
    void __cdecl mutex_init_in_situ(MutexHandle mutex, MutexType init) { _Mtx_init_in_situ(_to_<_Mtx_t>(mutex), _uc_(init)); }
    ...
    ThreadState __cdecl mutex_trylock(MutexHandle mutex) { return _ec_<ThreadState>(_Mtx_trylock(_to_<_Mtx_t>(mutex))); }
    ...
    void __cdecl cond_unregister_at_thread_exit(MutexHandle mutex) { _Cnd_unregister_at_thread_exit(_to_<_Mtx_t>(mutex)); }
