...
namespace ARLib {
    ...
    int pthread_attr_destroy(PthreadAttr* attr) { return ::pthread_attr_destroy(cast<pthread_attr_t*>(attr)); }
    ...
    int pthread_attr_init(PthreadAttr* attr) { return ::pthread_attr_init(cast<pthread_attr_t*>(attr)); }
    ...
    int pthread_cond_broadcast(PthreadCond* cond) { return ::pthread_cond_broadcast(cast<pthread_cond_t*>(cond)); }
    int pthread_cond_destroy(PthreadCond* cond) { return ::pthread_cond_destroy(cast<pthread_cond_t*>(cond)); }
    ...
    int pthread_cond_signal(PthreadCond* cond) { return ::pthread_cond_signal(cast<pthread_cond_t*>(cond)); }
    int pthread_cond_timedwait(PthreadCond* cond, PthreadMutex* mutex, const TimeSpec* spec) {
        return ::pthread_cond_timedwait(cast<pthread_cond_t*>(cond), cast<pthread_mutex_t*>(mutex),
                                        cast<const timespec*>(spec));
    }
    ...
    int pthread_mutex_destroy(PthreadMutex* mutex) { return ::pthread_mutex_destroy(cast<pthread_mutex_t*>(mutex)); }
#ifndef ON_MINGW
    ...
    int pthread_mutex_lock(PthreadMutex* mutex) { return ::pthread_mutex_lock(cast<pthread_mutex_t*>(mutex)); }
#ifndef ON_MINGW
...
#endif
    int pthread_mutex_trylock(PthreadMutex* mutex) { return ::pthread_mutex_trylock(cast<pthread_mutex_t*>(mutex)); }
    ...
    int pthread_mutex_unlock(PthreadMutex* mutex) { return ::pthread_mutex_unlock(cast<pthread_mutex_t*>(mutex)); }
    ...
    int pthread_rwlock_destroy(PthreadRWLock* lock) { return ::pthread_rwlock_destroy(cast<pthread_rwlock_t*>(lock)); }
    ...
    int pthread_rwlock_rdlock(PthreadRWLock* lock) { return ::pthread_rwlock_rdlock(cast<pthread_rwlock_t*>(lock)); }
    ...
    int pthread_rwlock_unlock(PthreadRWLock* lock) { return ::pthread_rwlock_unlock(cast<pthread_rwlock_t*>(lock)); }
    int pthread_rwlock_wrlock(PthreadRWLock* lock) { return ::pthread_rwlock_wrlock(cast<pthread_rwlock_t*>(lock)); }
    ...
    Pthread pthread_self(void) { return cast<Pthread>(::pthread_self()); }
