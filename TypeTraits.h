...
namespace ARLib {
    ...
    struct PointerTraits {
        ...
        static constexpr Ptr pointer_to(MakeNotVoid<element_type>& e) { return Ptr::pointer_to(e); }
    ...
    struct PointerTraits<T*> {
        ...
        static constexpr pointer pointer_to(MakeNotVoid<element_type>& r) noexcept { return addressof(r); }
    };
    ...
    struct Convertible :
        IntegralConstant<bool, (decltype(detail::TestReturnable<To>(
                               0))::value&& decltype(detail::TestImplicitlyConvertible<From, To>(0))::value) ||
    ...
    struct BaseOf :
        IntegralConstant<bool, IsClass<Base>::value &&
                               IsClass<Derived>::value&& decltype(detail::TestPreIsBaseOf<Base, Derived>(0))::value> {};

    // constructible in various ways -> todo in concepts
    template <class T>
    struct CopyConstructibleImpl :
        ConstructibleImpl<T, typename AddLvalueReference<typename AddConst<T>::type>::type> {};
    ...
    namespace detail {
        ...
        struct ResultOfMemFunRefImpl {
            ...
            static ResultOfSuccess<decltype((declval<T>().*declval<F>())(declval<Args>()...)), InvokeMemfunRef>
            s_test(int);
        ...
        struct ResultOfMemObj<Res Class::*, Arg> {
            ...
            typedef
            typename Conditional<Or<IsSame<Argval, Class>, BaseOf<Class, Argval>>::value,
                                 ResultOfMemObjRef<Memptr, Arg>, ResultOfMemObjDeref<Memptr, Arg>>::type::type type;
        };
        ...
        struct ResultOfMemFun<Res Class::*, Arg, Args...> {
            ...
            typedef Res Class::*MemPtr;
            typedef typename Conditional<BaseOf<Class, Argval>::value, ResultOfMemFunRef<MemPtr, Arg, Args...>,
        ...
        struct InvokeResultForFunc :
            public ResultOfImpl<IsMemberObjectPointer<typename RemoveReference<Functor>::type>::value,
                                IsMemberFunctionPointer<typename RemoveReference<Functor>::type>::value, Functor,
                                Args...>::type {};
    } // namespace detail
    ...
    struct IsInvokableImpl<Result, Ret,
