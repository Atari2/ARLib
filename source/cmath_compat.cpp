...
double ceil(double x) {
    return _mm_cvtsd_f64(_mm_round_sd(_mm_undefined_pd(), _mm_set_sd(x), _MM_FROUND_TO_POS_INF | _MM_FROUND_NO_EXC));
}
double floor(double x) {
    return _mm_cvtsd_f64(_mm_round_sd(_mm_undefined_pd(), _mm_set_sd(x), _MM_FROUND_TO_NEG_INF | _MM_FROUND_NO_EXC));
}
...
double round(double x) {
    return _mm_cvtsd_f64(_mm_round_sd(_mm_undefined_pd(), _mm_set_sd(x), _MM_FROUND_TO_NEAREST_INT | _MM_FROUND_NO_EXC)
    );
}
}    // namespace ARLib
