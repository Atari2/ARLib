...
class SSOVector {
    ...
    SSOVector(const SSOVector<T, OTHER_SSO>& other)
    ...
    template <size_t OTHER_SSO>
    SSOVector& operator=(const SSOVector<T, OTHER_SSO>& other)
    requires(SSO != OTHER_SSO)
    {
        m_size = other.size();
    ...
    template <size_t OTHER_SSO>
    SSOVector& operator=(SSOVector<T, OTHER_SSO>&& other)
    requires(SSO != OTHER_SSO)
    {
        release_strong();
        m_size = other.size();
